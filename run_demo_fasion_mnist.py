...
if __name__ == '__main__':
    perm_type = types.Permutation_options(
        args.permutation_arrangement)
    model = vpnn(28*28,
    ...
    (x_train, y_train), (x_test, y_test) = donwload_util.load_mnist_fasion_stash()
    ...
    print('max_range=', args.permutation_max_range)
    ...
    tf.saved_model.save(model, f'models/fashion-mnist/{args.name}-final')
    print('All done :)')
